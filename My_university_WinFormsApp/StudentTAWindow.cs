...
{
    public partial class StudentTAWindow : Form
    {
        ...
        //------------------------------------------------------------------------------------
        public StudentTAWindow(StudentTA user)
        {

            InitializeComponent();
            createStudentTAWindowPage();
        ...
        private void createStudentTAWindowPage ()
        {
            topPanel = new Panel();
            ...
            courseTaught.Location = new Point(0, 319);
        ...
        private void StudentTAWindow_Load(object sender, EventArgs e)
        {
        ...
        private void createSearchPage()
        {
            ...
            searshBox.PlaceholderText = " הזן שם סטודנט, מרצה, קורס או מחלקה";
        ...
        private void createCourseTaughtPage()
        {
           // courseTaughtPanel.AutoScroll = true; // אופציונלי אבל בדרכ מרצה מלמד 3 4 קורסים אפילו פחות אז לא צריך 
            ...
            for (int i = 0; i < this.user.CourseTaught.Count; i++) {
                ...
                coursesTaught.Text= this.user.CourseTaught[i].Name;
                ...
                baseYstudents = 10;
                for (int j = 0; j < this.user.CourseTaught[i].Students.Count; j++)
                {
                    ...
                    fullName = this.user.CourseTaught[i].Students[j].Name + " " + this.user.CourseTaught[i].Students[j].FmName;
        ...
        private void ShowMyStudents(object? sender, EventArgs e)
        {
            ...
            for (int i = 0; i < this.user.CourseTaught[courseNumber].Students.Count; i++)
            {
        ...
        private void ChangeMood(object sender, EventArgs e)
        {
            ...
            if (this.isDay)
            {
                ...
                {"coursesPanel","infroPanel","settingsPanel" ,"searchingPanel","showMessages","sendMessages","courseTaughtPanel" };
        ...
        {
            // הפאנלים שיש:     מידע אישי, הודעות , חיפוש , הגדרות , כל הקורסים , הקורסים שאני מלמד
        ...
        private void logOut_Click(object sender, EventArgs e)
        {
            ...
            HeadOfDepartment.WriteStudentTAToFile(this.user);
